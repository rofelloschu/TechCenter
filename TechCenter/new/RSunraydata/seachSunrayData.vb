...
Public Class seachSunrayData
    ...
    Private t_autoSeach As Threading.Thread
    ...
    Sub New()
        ...
        t_autoSeach = New Threading.Thread(AddressOf AddressOf_autoSeach)
        t_autoSeach.Start()
    End Sub

    Private Sub AddressOf_autoSeach()
        While True
            Threading.Thread.Sleep(1000)
            If m_willSeach_date.Count = 0 Then
                Threading.Thread.Sleep(60000)
            Else
                '找資料
                Dim time As DateTime = m_willSeach_date.getFirstValue
                Me.WriteFFF3(time)

            End If
        End While
    End Sub
    Sub ReceivedFFF9(data_fff9 As sunray_format_FFF9)
    ...
    Event WriteFFF3Data(data() As Byte)
    Sub WriteFFF3(TargetDataTime As DateTime)
    ...
    End Sub
    Sub addDate(data_date As DateTime)
        m_willSeach_date.Add(data_date)
