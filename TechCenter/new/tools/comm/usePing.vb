...
Public Class usePing
    ...
    Sub testPing(ip As String)
        ...
        Catch generatedExceptionName As SocketException
            ...
            Console.WriteLine(ip + " time Out")
            MsgBox(ip + " time Out")
            Return
        Catch ex As Exception
            Console.WriteLine(ex.ToString)
            MsgBox(ip + ex.ToString)
            Return
        End Try
        '    End If
        ...
        Dim response As New Simple_Ping_format(data, recv)
