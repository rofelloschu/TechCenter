...
#End Region
    ...
    Public Function load() As String()
        If System.IO.File.Exists(Me.m_Path) Then
            ...
            data = System.IO.File.ReadAllLines(Me.m_Path)
            'data = read()
            Return data
        Else
            Throw New Exception(m_Path)
            Return Nothing
        End If
...
#Region "讀出"
    ...
    Public Function read(ByVal keyword As String, ByVal endword As String) As String()
        Try
            Dim sr As New StreamReader(m_Path, System.Text.Encoding.Default)
