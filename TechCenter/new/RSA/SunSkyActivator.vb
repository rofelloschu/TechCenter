...
'Namespace SunSkyActivator
Public NotInheritable Class SunSkyActivator
    Private Shared _SunSkyActivator As SunSkyActivator = New SunSkyActivator()
    ...
    Private Sub New()
        Dim cp As Computer = New Computer()
        CpuID = cp.CpuID
        fileName = CpuID & ".spc"
        _isoStore = IsolatedStorageFile.GetStore(IsolatedStorageScope.Machine Or IsolatedStorageScope.Assembly, Nothing, Nothing)
    End Sub
